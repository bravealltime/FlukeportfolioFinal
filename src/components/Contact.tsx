...
const Contact = () => {
    ...
    return (
        <section id="contact" className="py-24 px-4 bg-transparent font-mono relative overflow-hidden z-10">
            <div className={`max-w-4xl mx-auto text-center border relative ${isHuman ? "border-slate-200 bg-white/50 backdrop-blur-xl shadow-xl rounded-2xl p-12" : "border-[#10b98144] p-8 md:p-16 bg-[#0a0a0a]/40 hacker-border backdrop-blur-md"}`}>
                ...
                >
                    ...
                    <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
                        <motion.a
                            ...
                            whileHover={isHuman ? { scale: 1.02 } : { scale: 1.05, backgroundColor: "#10b981", color: "#000" }}
                        ...
                        <div className="flex gap-4">
                            <motion.button
                                onMouseEnter={() => !isHuman && playPing()}
                                onClick={() => !isHuman && playKeyPress()}
                                whileHover={isHuman ? { scale: 1.05 } : { scale: 1.1, backgroundColor: "#10b98133" }}
                                whileTap={{ scale: 0.9 }}
